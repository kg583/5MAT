...
class SampleTests(unittest.TestCase):
    def sample(self, sample: str, expected: str, input: str = "", *, max_lifetimes: int = None, length: int = None):
        program = Path(__file__).parents[2].joinpath(f"docs/samples/5MAT/{sample}.5mat").read_text(encoding="utf8")
    ...
    def test_truth_machine(self):
        ...
        self.sample("truth-machine", "11111", "1", max_lifetimes=5)
